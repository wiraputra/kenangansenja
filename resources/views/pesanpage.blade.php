...
<body>
    ...
    @endif
        ...
        <div class="text-center mt-12">
            <a 
                href="{{ route('promotepage') }}" 
                class="inline-block px-8 py-4 bg-yellow-500 text-white font-semibold rounded-full shadow-md hover:bg-yellow-400 transition-colors duration-300 ease-out transform hover:scale-110 shadow hover:shadow-yellow-400 hover:shadow-sm">
                Lihat Menu Promosi
            </a>
        </div>
    </div>
